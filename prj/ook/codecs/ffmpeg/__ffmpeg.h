...
#define __FFMPEG_H__
  ...
  #ifdef WIN32
	///#include SRCPATH(avcodec.h)
  #endif
#endif

#if defined(FFMPEG_V_55_18) || defined(FFMPEG_V_55_39) || defined(FFMPEG_V_56_60) || defined(FFMPEG_3_1)
